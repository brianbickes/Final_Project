        ...
        return (
            ...
            <div>
                ...
                <form action="/dogs" method="POST">
                    ...
                    <label HTMLFor="isCatFixed">Is Cat Spayed or Neutered?</label><input type="boolean" name="isCatFixed" id="isCatFixed"></input><br/>
                    <label HTMLFor="isCatDeclawed">Is Cat Declawed?</label><input type="boolean" name="isCatDeclawed" id="isCatDeclawed"></input><br/>
