...
class Edit extends React.Component {
  render() {
    ...
    return (
      <Default>
        <div>
          <form action={`/cats/${id}/?_method=PUT`} method="POST">
          <label htmlFor="name">Cat Name: </label><input type="text" name="name" id="name" defaultValue={name} /><br />
            ...
            <label htmlFor="isCatDeclawed">Declawed: </label><input type="checkbox" name="isCatDeclawed" id="isCatDeclawed" defaultValue={isCatDeclawed} /> <br />
            <label htmlFor="isCatFixed">Spayed or Neutered: </label><input type="checkbox" name="isCatFixed" id="isCatFixed" defaultValue={isCatFixed} /> <br />
